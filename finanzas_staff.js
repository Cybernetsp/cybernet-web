...
/* ==========================================================================
   👥 CONTROL DE PANELES DE PERSONAL Y CALENDARIO (VINCULACIÓN A personal_staff.js)
   ========================================================================== */
window.toggleShiftsPanel = function () {
  ...
  if (estaAbierto) {
    ...
    if (esSuperAdmin) {
      if (btnAde) btnAde.style.setProperty("display", "inline-flex", "important");
      if (btnNom) btnNom.style.setProperty("display", "inline-flex", "important");
    } else {
