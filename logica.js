  ...
  (function() {
    ...
    if (!user) {
      if (!esPaginaLogin) {
        ...
        window.location.href = currentUrl.includes(".html") ? "login.html" : "login";
      }
    } 
    // Si SÍ hay usuario logueado
      ...
      if (esPaginaLogin) {
        ...
        window.location.href = currentUrl.includes(".html") ? "admin.html" : "admin";
      } else {
  ...
  // Tu código normal continúa aquí abajo:
  ...
  function validateStaffAccess(e) {
    ...
    window.procesarLoginSheets = function (res) {
      ...
      if (res && res.status === "success") {
        ...
        window.location.href = "admin"; // Redirige al admin real
      } else {
